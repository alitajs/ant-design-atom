export default {
  ...
  'accountandsettings.basic.profile-message':
    'Please input your personal profile!',
  'accountandsettings.basic.profile-placeholder':
  ...
  'accountandsettings.basic.geographic-message':
  ...
  'accountandsettings.basic.update.success':
  ...
  'accountandsettings.security.password-description':
  ...
  'accountandsettings.binding.alipay-description':
    'Currently unbound Alipay account',
  'accountandsettings.binding.dingding': 'Binding DingTalk',
  'accountandsettings.binding.dingding-description':
